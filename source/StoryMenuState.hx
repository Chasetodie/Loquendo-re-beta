...
class StoryMenuState extends MusicBeatState
{
	...
	var weekNames:Array<String> = [
		...
		"I dont`t download it because I already have it"
	];
	...
	override function create()
	{
		...
		yellowBG.frames = Paths.getSparrowAtlas('yellow_bg');
		yellowBG.antialiasing = true;
		yellowBG.animation.addByPrefix('yellow', 'yellow bg', 24);
		yellowBG.animation.play('yellow');
